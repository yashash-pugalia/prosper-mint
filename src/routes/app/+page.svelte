...
<div class="flex flex-col gap-2 py-4">
  ...
  <div class="flex gap-2 w-full">
    ...
    >
      <div
        class="bg-base-200 flex flex-col gap-2 p-1 border border-base-content/20 rounded"
      >
        <input
        ...
        <div
          class="bg-base-100 tabs tabs-boxed mr-auto border border-base-content/20"
        >
          <button
            class="tab"
        ...
        <tbody>
          {#each data.transactions as t}
            ...
            >
              ...
              <td>
                <p>
                  {new Date(t.timestamp ?? "").toLocaleString("default", {
                    month: "short",
                    day: "numeric",
                  })}
                </p>
              ...
              <td>
                <img
                  class="w-8 h-8"
                  src="/bank-logos/{t.bank.toLowerCase()}.png"
                  alt=""
                />
              </td>
            </tr>
    ...
    {#if selectedTrIds.length}
      <div
        ...
        in:fly={{ y: 32 }}
      >
        <span class="badge badge-neutral badge-lg mx-auto"
          >{selectedTrIds.length} selected</span
        >
