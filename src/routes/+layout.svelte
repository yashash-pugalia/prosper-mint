...
<div class="max-w-screen-xl p-4 w-full mx-auto min-h-screen">
  ...
  >
    ...
    <button
      ...
      class="btn btn-sm btn-ghost btn-square sm:hidden"
    >
    ...
    {#if showNav}
      <div
        class="flex gap-4 flex-col w-full sm:w-auto sm:flex-row"
        transition:slide
      >
        {#if !data.loggedIn}
          <a class="link link-hover" href="/auth/signup">Sign Up / Login</a>
        {/if}
